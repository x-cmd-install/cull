...
- **Star**: 160 · **Fork**: 4 · **开放 issue**: 5 · **贡献者**: 3

## 累计统计

- **发布数**: 12 · **已合并 PR**: 6 · **开放 PR**: 0 · **已关闭 issue**: 3 · **开放 issue**: 2 · **提交数**: 86
...
在 [repology.org](https://repology.org/project/cull) 上共有 **2** 个发行版报告此项目。**1** 个 ✅ 已是最新上游版本，**1** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T22:58:23Z._
